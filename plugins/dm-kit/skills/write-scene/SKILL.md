---
name: write-scene
description: "Loads when the user asks to 'write a scene', 'write read-aloud', 'describe this place', 'write atmosphere', 'draft the scene opening', 'write the encounter description', 'make this feel more [tense / eerie / hopeful]', or is drafting Danish player-facing prose for any scene, encounter, puzzle, or location in a D&D campaign vault. Provides principles, structure patterns, and template snippets for writing Danish read-aloud and English DM mechanics in the vault's conventions."
---
